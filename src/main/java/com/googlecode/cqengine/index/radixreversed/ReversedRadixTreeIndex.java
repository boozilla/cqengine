 ...
 */
public class ReversedRadixTreeIndex<A extends CharSequence, O> extends AbstractAttributeIndex<A, O> implements OnHeapTypeIndex, PrimaryKeyOrderedAttributeIndex<O> {
