...
public class GeneralFunctionalTest {
    ...
    public void testGeneralFunctionality() {
        ...
        cars.add(new Car(1, "Ford",   "Focus",  Car.Color.BLUE,  5, 9000.50, Collections.emptyList(), Collections.emptyList()));
        cars.add(new Car(2, "Ford",   "Fiesta", Car.Color.BLUE,  2, 5000.00, Collections.emptyList(), Collections.emptyList()));
        cars.add(new Car(3, "Ford",   "F-150",  Car.Color.RED,   2, 9500.00, Collections.emptyList(), Collections.emptyList()));
        cars.add(new Car(4, "Honda",  "Civic",  Car.Color.RED,   5, 5000.00, Collections.emptyList(), Collections.emptyList()));
        cars.add(new Car(5, "Toyota", "Prius",  Car.Color.BLACK, 3, 9700.00, Collections.emptyList(), Collections.emptyList()));
